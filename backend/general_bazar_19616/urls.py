"""general_bazar_19616 URL Configuration
...
admin.site.site_header = "General Bazar"
admin.site.site_title = "General Bazar Admin Portal"
admin.site.index_title = "General Bazar Admin"

# swagger
api_info = openapi.Info(
    title="General Bazar API",
    default_version="v1",
    description="API documentation for General Bazar App",
)
